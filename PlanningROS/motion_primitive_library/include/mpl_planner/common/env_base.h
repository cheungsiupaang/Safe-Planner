...
class env_base {
 public:
  ...
  void set_v_max_quad(decimal_t v) { v_max_quad = v; }

  /// Set max acc in each axis
  void set_a_max_quad(decimal_t a) { a_max_quad = a; }
  ...
  /// max velocity
  decimal_t v_max_quad{-1.0};
  /// max acceleration
  decimal_t a_max_quad{-1.0};
  /// max jerk
  decimal_t j_max_qaud{-1.0};
